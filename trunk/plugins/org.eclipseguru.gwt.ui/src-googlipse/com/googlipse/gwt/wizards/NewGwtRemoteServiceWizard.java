...
public class NewGwtRemoteServiceWizard extends NewElementWizard {
	...
	private NewGwtRemoteServiceWizardPage remoteServiceWizardPage;

	private IStructuredSelection selection;

	public NewGwtRemoteServiceWizard() {
		setDefaultPageImageDescriptor(ImageDescriptor.createFromFile(this.getClass(), "/icons/new_remote_service.gif"));
	...
	public void addPages() {
		super.addPages();
		remoteServiceWizardPage = new NewGwtRemoteServiceWizardPage();
		addPage(remoteServiceWizardPage);
		remoteServiceWizardPage.init(selection);
	}
